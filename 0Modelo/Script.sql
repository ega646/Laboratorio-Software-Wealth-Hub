...
ALTER TABLE "public"."activosposeidos" ALTER COLUMN "idrelacion" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE TABLE IF NOT EXISTS "public"."perfiles" (
    ...
    "divisabasecodigo" character varying(3),
...
ALTER TABLE ONLY "public"."activosposeidos"
    ADD CONSTRAINT "activosposeidos_pkey" PRIMARY KEY ("idrelacion");
