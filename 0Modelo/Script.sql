...
ALTER FUNCTION "public"."resumen_portfolio"("p_user_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."activosposeidos" (
    ...
    "id" bigint NOT NULL,
    "cuenta_origen" character varying
);
...
COMMENT ON COLUMN "public"."activosposeidos"."cuenta_origen" IS 'Cuenta de origen si el dato viene de vinculacion';
...
COMMENT ON COLUMN "public"."cuentas"."numerocuenta" IS 'pk intera';



ALTER TABLE "public"."cuentas" ALTER COLUMN "numerocuenta" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE TABLE IF NOT EXISTS "public"."recomendaciones" (
    ...
    "severidad" character varying(10) DEFAULT 'info'::character varying NOT NULL,
    ...
    CONSTRAINT "recomendaciones_estado_check" CHECK ((("estado")::"text" = ANY ((ARRAY['activa'::character varying, 'ignorada'::character varying, 'recordar'::character varying])::"text"[]))),
    CONSTRAINT "recomendaciones_severidad_check" CHECK ((("severidad")::"text" = ANY ((ARRAY['info'::character varying, 'warn'::character varying, 'critical'::character varying])::"text"[])))
);
...
CREATE SEQUENCE IF NOT EXISTS "public"."recomendaciones_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."activosposeidos"
    ADD CONSTRAINT "activos_usuario_origen_unique" UNIQUE ("activocodigo", "usuario_id", "cuenta_origen");
...
ALTER TABLE ONLY "public"."cambios"
    ADD CONSTRAINT "cambios_divisaorigen_divisadestino_fecini_key" UNIQUE ("divisaorigen", "divisadestino", "fecini");
...
ALTER TABLE ONLY "public"."cuentas"
    ADD CONSTRAINT "cuentas_usuario_tipo_unique" UNIQUE ("usuario_id", "tipocuentacodigo");
...
ALTER TABLE ONLY "public"."valorhistoricoactivo"
    ADD CONSTRAINT "valorhistoricoactivo_activocodigo_fecha_key" UNIQUE ("activocodigo", "fecha");
...
CREATE INDEX "idx_recomendaciones_usuario" ON "public"."recomendaciones" USING "btree" ("usuario_id", "estado");
...
ALTER TABLE ONLY "public"."activosposeidos"
    ADD CONSTRAINT "activosposeidos_cuenta_origen_fkey" FOREIGN KEY ("cuenta_origen") REFERENCES "public"."tiposcuentas"("codigo");
...
ALTER TABLE ONLY "public"."recomendaciones"
    ADD CONSTRAINT "recomendaciones_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Usuario actualiza sus recomendaciones" ON "public"."recomendaciones" FOR UPDATE USING (("auth"."uid"() = "usuario_id"));
...
CREATE POLICY "Usuario borra sus recomendaciones" ON "public"."recomendaciones" FOR DELETE USING (("auth"."uid"() = "usuario_id"));
...
CREATE POLICY "Usuario inserta sus recomendaciones" ON "public"."recomendaciones" FOR INSERT WITH CHECK (("auth"."uid"() = "usuario_id"));
...
CREATE POLICY "Usuario ve sus recomendaciones" ON "public"."recomendaciones" FOR SELECT USING (("auth"."uid"() = "usuario_id"));
...
GRANT ALL ON FUNCTION "public"."resumen_portfolio"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."resumen_portfolio"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."resumen_portfolio"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."cuentas_numerocuenta_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."cuentas_numerocuenta_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."cuentas_numerocuenta_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."recomendaciones" TO "anon";
GRANT ALL ON TABLE "public"."recomendaciones" TO "authenticated";
GRANT ALL ON TABLE "public"."recomendaciones" TO "service_role";



GRANT ALL ON SEQUENCE "public"."recomendaciones_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."recomendaciones_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."recomendaciones_id_seq" TO "service_role";
