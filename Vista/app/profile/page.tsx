          ...
          <CardContent className="p-12">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-2xl text-zinc-400 mt-2">manuel.garcia@email.com</p>
      ...
      <CardContent className="space-y-8 pt-4">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-xl font-medium text-white">Manuel García</p>
          </div>
          <div>
            <p className="text-zinc-500 text-sm mb-1">Correo electrónico</p>
            <p className="text-xl font-medium text-white">manuel.garcia@email.com</p>
          </div>
        </div>
